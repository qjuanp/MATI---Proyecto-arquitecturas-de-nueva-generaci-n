...
~/spark-1.6.0-bin-hadoop2.6/bin/spark-submit --packages org.apache.spark:spark-streaming-kafka_2.10:1.6.1,org.mongodb.mongo-hadoop:mongo-hadoop-core:1.5.1 spark.py  
